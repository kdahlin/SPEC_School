...
# data table
x.min <- min(neon.points.sub$Longitude, na.rm = T) - 5
x.max <- max(neon.points.sub$Longitude, na.rm = T) + 5
y.min <- min(neon.points.sub$Latitude, na.rm = T) - 5
y.max <- max(neon.points.sub$Latitude, na.rm = T) + 5
