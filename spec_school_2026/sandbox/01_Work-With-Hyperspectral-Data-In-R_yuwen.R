...
# script associated with https://www.neonscience.org/resources/learning-hub/tutorials/introduction-hyperspectral-remote-sensing-data-r#toggle-3 
...
b34 <- h5read(h5_file,"/MLBS/Reflectance/Reflectance_Data",index=list(34,1:nCols,1:nRows)) 
...
h5EPSG <- h5read(h5_file, "/MLBS/Reflectance/Metadata/Coordinate_System/EPSG Code") #"32617"
