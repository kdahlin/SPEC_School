...
# I'm making a copy of this script (Adriana)

#let's load the necessary libraries
library(terra)
library(dplyr)
library(plyr) # this masks a lot of dplyr functions, which should be loaded first?
library(sf)
library(rlas)
library(tidyverse)

# source("Z:/shared_code/SPEC_School/canopyLazR_V2.R")
source('/Volumes/rs-016/ersamlab/shared_code/SPEC_School/canopyLazR_V2.R')
...
laz.files <- "/Volumes/rs-016/ersamlab/shared_data/NEON_AOP_data/MLBS/2022/lidar_pointcloud_2022/"
...
#prefix ##
wd <- "/Users/sestockman/Desktop/Spec School 2024/SPEC_School"
